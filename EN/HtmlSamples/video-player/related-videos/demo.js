$(function () {
            ...
            $("#player1").igVideoPlayer({
                ...
                width: 720,
                height: 560,
                posterUrl: "http://staging.igniteui.local/13-1/images/samples/video-player/quince-intro-1.png",
                fullscreen: false,
                ...
                relatedVideos: [
					{
					    imageUrl: "http://staging.igniteui.local/13-1/images/samples/video-player/quince-intro-2.png",
					    title: "Quince Presentation Part 1",
